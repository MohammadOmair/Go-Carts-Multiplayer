...
public class Racetrack extends JPanel implements KeyListener {
    ...
    public Racetrack() {
        ...
        kartImage1 = Toolkit.getDefaultToolkit().getImage("kart1.jpg");
        kartImage2 = Toolkit.getDefaultToolkit().getImage("kart2.jpg");
        kart1X = 400;
        kart1Y = 550;
        kart2X = 450;
        kart2Y = 550;
